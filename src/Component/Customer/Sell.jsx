...
const Sell = () => {
    ...
    const [location, setLocation] = useState(storedaddress);
    ...
    // Set a manual token on initial load for testing purposes
    useEffect(() => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/createscraplist', formData, {
                headers: {
